...
def generate_launch_description():
    ...
    rviz_config = os.path.join(pkg, "rviz", "rtabmap_view.rviz")

    rgbd_odometry_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(launch_dir, "rgbd_odometry.launch.py")
        ),
        launch_arguments={
            "robot_ns": robot_ns,
    ...
    rtabmap_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(launch_dir, "rtabmap.launch.py")),
        launch_arguments={
            "robot_ns": robot_ns,
            "use_sim_time": use_sim_time,
    ...
    ld.add_action(launch_rtabmapviz_cmd)
